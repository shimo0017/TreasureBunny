...
void PauseSelectUi::Draw(bool isTitle, int selectFontHandle, int nSelectFontHandle, int boardImg)
{
	...
	DrawStringFToHandle(FontBaseX + FontCorrectionX, FontBaseY+ FontCorrectionY, "タイトル", BlackColor, selectFontHandle);
	...
	DrawStringFToHandle(FontBaseX + CorrectionX+FontCorrectionX, FontBaseY+ FontCorrectionY, "続ける", BlackColor, selectFontHandle);
	DrawStringFToHandle(FontBaseX + CorrectionX, FontBaseY, "続ける", WhiteColor, selectFontHandle);
